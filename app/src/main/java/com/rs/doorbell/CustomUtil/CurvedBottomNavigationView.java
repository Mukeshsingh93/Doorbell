package com.rs.doorbell.CustomUtil;
...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    private final int CURVE_CIRCLE_RADIUS = 256 / 3;
    ...
    private void init() {
        ...
        mPaint.setColor(Utility.getAttrColor(getContext(), R.attr.colorBottomNavigation));

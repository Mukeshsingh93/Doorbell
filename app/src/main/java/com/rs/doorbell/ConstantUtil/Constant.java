package com.rs.doorbell.ConstantUtil;


import com.google.android.gms.maps.model.LatLng;
import com.rs.doorbell.BuildConfig;
...
public class Constant {
    ...
    public static enum CONNECTION {
        ...
        ORDER_HISTORY, ADD_FAVOURITES, DELETE_FAVOURITES, ALL_FAVOURITES, PRIVACY_POLICY, DOWNLOAD, HOME, CONFIGURATION, DELETE_PAYMENT_CARD, RIDER_CURRENT_ORDER,update_rider_location,
        RIDER_HISTORY_ORDER, ORDER_STATUS, RIDER_DOCUMENT, RIDER_ADD_DOCUMENT, ENABLE_DISABLE_RIDER,DELETE_DOCUMENT,RIDER_BANK_DETAIL,UPDATE,USER_NOTIFICATION,sendRiderAccpetNotification
    }
    ...
    public static class ServerInformation {
     ...
     //   static String BASE_URL = "http://ozzyfood.online/";
        static String BASE_URL = "http://Doorbellservice.online/";

        public static String REST_API_URL = BASE_URL  + "food_delivery_home.php";

        public static String PICTURE_URL = BASE_URL  + "admin/uploads/image/";
        public static String VIDEO_URL = BASE_URL  + "admin/uploads/video/";
        public static String FACEBOOK_HIGH_PIXEL_URL = "?type=large&redirect=true&width=300&height=300";

        public static String DESKTOP_NEW_LINKS = BASE_URL + "food_delivery.php?post_id=%s&post_type=%s&post_name=%s&play_store=%s";
    ...
    public static class Credentials {
        ...
        public static String MAP_BOX_API_KEY = BuildConfig.MapboxApiKey;

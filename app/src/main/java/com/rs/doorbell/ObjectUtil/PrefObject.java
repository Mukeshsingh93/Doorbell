...
public class PrefObject {
    ...
    private boolean saveRiderStatus;
    private boolean retrieveRiderStatus;
    private boolean riderStatus;


    public boolean isSaveRiderStatus() {
        return saveRiderStatus;
    }

    public PrefObject setSaveRiderStatus(boolean saveRiderStatus) {
        this.saveRiderStatus = saveRiderStatus;
        return this;
    }

    public boolean isRetrieveRiderStatus() {
        return retrieveRiderStatus;
    }

    public PrefObject setRetrieveRiderStatus(boolean retrieveRiderStatus) {
        this.retrieveRiderStatus = retrieveRiderStatus;
        return this;
    }
    ...
    public PrefObject setRiderStatus(boolean riderStatus) {

...
public class HomeJson implements Parcelable
{
    ...
    protected HomeJson(Parcel in) {
        ...
        in.readList(this.featured, (com.rs.doorbell.JsonUtil.HomeUtil.Featured.class.getClassLoader()));
        in.readList(this.trending, (com.rs.doorbell.JsonUtil.HomeUtil.Trending.class.getClassLoader()));
        in.readList(this.nearest, (com.rs.doorbell.JsonUtil.HomeUtil.Nearest.class.getClassLoader()));
    }

...
package com.rs.doorbell.JsonUtil.HomeUtil;
...
public class Nearest implements Parcelable
{
    ...
    public Nearest setDelivery_charges(String delivery_charges) {
    ...
    public Nearest setNo_of_ratings(String no_of_ratings) {
    ...
    public Nearest setCurrency(String currency) {
    ...
    public Nearest setCurrency_symbol(String currency_symbol) {
    ...
    public Nearest setRestaurant_status(String restaurant_status) {
    ...
    public Nearest setReviewers(List<String> reviewers) {
    ...
    public Nearest setPayment_method(List<String> payment_method) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.restaurant_status);
    ...
    protected Nearest(Parcel in) {
        ...
        this.restaurant_status = in.readString();
    ...
    public static final Creator<Nearest> CREATOR = new Creator<Nearest>() {
        @Override
        public Nearest createFromParcel(Parcel source) {
            return new Nearest(source);
        }

        @Override
        public Nearest[] newArray(int size) {
            return new Nearest[size];
        }
    };
}
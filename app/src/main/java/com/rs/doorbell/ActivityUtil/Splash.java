...
import com.rs.doorbell.InterfaceUtil.InternetCallback;
        ...
        if (requestCode == Constant.RequestCode.PERMISSION_REQUEST_CODE) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if (checkSelfPermission(Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_DENIED) {
                    Utility.Toaster(this, Utility.getStringFromRes(this, R.string.need_call_permission), Toast.LENGTH_SHORT);
                    return;
                }
